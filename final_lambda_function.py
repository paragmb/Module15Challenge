...
def investment_recommendation(risk_level):
    """
    Returns a investment recommendation based on the user's selected risk level.
    """
    recommendation = ""
    if risk_level == "None":
        ...
        recommendation = "Please check your entry for risk level. Select None, Low, Medium or High."
    ...
    if age is not None:
        ...
        if age <= 0 or age > 65:
            return build_validation_result(
                False,
                "age",
                "No Recommended Investment Portfolio for the age entered. Please enter a value between 0 and 65.",
            )
    ...
    if investment_amount is not None:
        ...
        if investment_amount < 5000:
            return build_validation_result(
                ...
                "please provide a correct value of investment amount.",
            )
...
def recommend_portfolio(intent_request):
    ...
    # Return a message with recommendation.
    return close(
        intent_request["sessionAttributes"],
        "Fulfilled",
        {
            ...
            Here is the investment recommendation for your risk level:
            {}
            """.format(
                first_name, investment_recommendation(risk_level)
            ),
        },
    )
### Intents Dispatcher ###
